...
SECRET_KEY = 'rpvl77&8hj4#@j$670%vnuwnog9z+u8i*$04(zke3m77%q$378'
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(os.path.dirname(__file__), '../login_registration/')],
        # /Users/mroggers/Google Drive/Dojo/Week5/Django/login_registration/login_registration/templates/base.html
